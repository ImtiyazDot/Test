...
#if QA
            {
                BussinessLogic.GlobalVariables.CustomerURL = "http://apistaging.aws.rtfs.in";
                BussinessLogic.GlobalVariables.BookingURL = "http://iospush.taxiforsure.com";
                BussinessLogic.GlobalVariables.OTPURL = "http://54.255.57.96:8881";
                BussinessLogic.GlobalVariables.ApplicationConfig = "http://iospush.taxiforsure.com";
            }
#else
            {
                BussinessLogic.GlobalVariables.CustomerURL = "http://apistaging.aws.rtfs.in";
