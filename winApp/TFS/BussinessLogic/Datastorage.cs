...
namespace TFS.BussinessLogic
{
    public static class Datastorage
    {
        ...
        public static GeoCoordinate GeoLocation
        {
            get
            {
                if (localSettings.Contains("Geolocation"))
                    return (GeoCoordinate)localSettings["Geolocation"];
                else
                    return null;
            }
            set { localSettings["Geolocation"] = value; }
        }
